# Coffee Machine OpenAPI Specification
[![Build Status](https://travis-ci.org/etsi-cti-admin/test-oas-gen.svg?branch=master)](https://travis-ci.org/etsi-cti-admin/test-oas-gen)
...
6. If you did everything correct, https://etsi-cti-admin.github.io/test-oas-gen/ will lead to your new docs
...
- Documentation(ReDoc): https://etsi-cti-admin.github.io/test-oas-gen/
- SwaggerUI: https://etsi-cti-admin.github.io/test-oas-gen/swagger-ui/
- Look full spec:
    + JSON https://etsi-cti-admin.github.io/test-oas-gen/swagger.json
    + YAML https://etsi-cti-admin.github.io/test-oas-gen/swagger.yaml
- Preview spec version for branch `[branch]`: https://etsi-cti-admin.github.io/test-oas-gen/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://etsi-cti-admin.github.io/test-oas-gen/ with url from the message: `Server started <url>`
